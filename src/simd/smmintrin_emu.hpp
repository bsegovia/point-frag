...
#ifndef __PF_SMMINTRIN_EMU_H__
#define __PF_SMMINTRIN_EMU_H__
...
INLINE __m128i _mm_min_epi32( __m128i value, __m128i input ) { return _mm_blendv_epi8(input, value, _mm_cmplt_epi32(value, input)); }
INLINE __m128i _mm_max_epi32( __m128i value, __m128i input ) { return _mm_blendv_epi8(value, input, _mm_cmplt_epi32(value, input)); }

INLINE int _mm_extract_epi32( __m128i input, const int index ) {
  switch ( index ) {
