...
#ifndef __PF_RB_TREE_HPP__
#define __PF_RB_TREE_HPP__
...
namespace pf
{
  ...
  template<class TTreeTraits, class TAllocator = pf::allocator>
  ...
  public:
    ...
    void swap(rb_tree_base& other)
    {
      ...
      {
        validate();
        PF_ASSERT(m_allocator == other.m_allocator);
        pf::swap(m_root, other.m_root);
        pf::swap(m_size, other.m_size);
        validate();
      }
    }
  ...
  template<typename TKey, class TAllocator = pf::allocator>
  class rb_tree : public rb_tree_base<internal::rb_tree_traits<TKey>, TAllocator>
  {
    typedef rb_tree_base<internal::rb_tree_traits<TKey>, TAllocator> rb_tree_base_type;
  public:
    explicit rb_tree(TAllocator allocator = TAllocator()): rb_tree_base_type(allocator) {}
  };

} /* namespace pf */

#endif /* __PF_RB_TREE_HPP__ */
